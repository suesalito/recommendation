...
df = pd.read_csv('/Users/shying/Desktop/raw_102316.csv', header=None, low_memory=False,
...
print(train_array)
# import csv
# wr = csv.writer(df, quoting=csv.QUjOTE_ALL)
# wr.writerow(train_array)
np.savetxt("/Users/shying/Desktop/output2.csv", train_array, delimiter=",", fmt='%s', header='')
np.savetxt("/Users/shying/Desktop/customerid.csv", cust_ind, delimiter=",", fmt='%s', header='')
np.savetxt("/Users/shying/Desktop/inventoryid.csv", invt_ind, delimiter=",", fmt='%s', header='invtid')
# ******** To set the print out untruncated representation
np.set_printoptions(threshold=np.inf)

print('customer id: ',cust_ind[20])
for i in range (0,train_array.shape[1]):
    if (train_array[20,i] == 1):
        print (invt_ind[i])
