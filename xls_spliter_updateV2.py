        ...
        for rownum in range(0,worksheet.nrows):
            if header:
                ...
                for c in range(0, worksheet.ncols):
                    ...
                    # print(cell.ctype)
                    # print(actual)
                    if cell.ctype == xlrd.XL_CELL_DATE and actual <> '' :
                        print(cell.ctype,'+',xlrd.XL_CELL_DATE)
                        ...
                        try:
                            ...
                            print("Cannot convert to Date Type")

                    # actual_values.append(actual)
                    actual_values.append(unicode(actual).encode("utf-8"))
                    # print(actual_values)
                row = actual_values
                row.insert(0,str(timestamp))
            wr.writerow(row)
...
if __name__ == "__main__":
    ...
    data_file = "C:\\Users\\suesa\\Desktop\\splitter\\RVTools_captain201_20200224.xls"
